...
public class GameService {
    ...
    private Ranking createGeneralRanking(Game game) {
        ...
        for (int rank = 0; rank < ranking.getScores().size(); rank++) {
            ...
            scores.add(new Score(score.getId(), score.getGame(), score.getPlayer(), score.getStage(), score.getShip(), score.getMode(), score.getDifficulty(), score.getComment(), score.getPlatform(), score.getValue(), score.getReplay(), rank + 1));
        }
